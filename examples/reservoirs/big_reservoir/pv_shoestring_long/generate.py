"""Long 'channel:PV_SHOESTRING' reservoir (1 x 10 blocks), uniform conditioning + azimuth gradient.
...
Raw scalars used (training median for layer 'channel:PV_SHOESTRING'):
    ntg                    0.226
    width_cells            6.97
    depth_cells            6.5
    mCHsinu                1.575
...
LAYER_TYPE_NAME = 'channel:PV_SHOESTRING'
RAW_SCALARS = {'ntg': 0.226, 'width_cells': 6.97, 'depth_cells': 6.5, 'mCHsinu': 1.575, 'mFFCHprop': 0.15, 'probAvulInside': 0.06}
