"""Long 'channel:SH_DISTAL' reservoir (1 x 10 blocks), uniform conditioning + azimuth gradient.
...
Raw scalars used (training median for layer 'channel:SH_DISTAL'):
    ntg                    0.62
    width_cells            11.51
    depth_cells            6.5
    mCHsinu                1.275
...
LAYER_TYPE_NAME = 'channel:SH_DISTAL'
RAW_SCALARS = {'ntg': 0.62, 'width_cells': 11.51, 'depth_cells': 6.5, 'mCHsinu': 1.275, 'mFFCHprop': 0.1, 'probAvulInside': 0.06}
