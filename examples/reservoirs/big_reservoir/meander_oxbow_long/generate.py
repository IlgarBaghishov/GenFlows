"""Long 'channel:MEANDER_OXBOW' reservoir (1 x 10 blocks), uniform conditioning + azimuth gradient.
...
Raw scalars used (training median for layer 'channel:MEANDER_OXBOW'):
    ntg                    0.415
    width_cells            6.97
    depth_cells            6.5
    mCHsinu                1.625
...
LAYER_TYPE_NAME = 'channel:MEANDER_OXBOW'
RAW_SCALARS = {'ntg': 0.415, 'width_cells': 6.97, 'depth_cells': 6.5, 'mCHsinu': 1.625, 'mFFCHprop': 0.0, 'probAvulInside': 0.0}
