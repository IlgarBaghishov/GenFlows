"""Long 'channel:CB_LABYRINTH' reservoir (1 x 10 blocks), uniform conditioning + azimuth gradient.
...
Raw scalars used (training median for layer 'channel:CB_LABYRINTH'):
    ntg                    0.372
    width_cells            10.18
    depth_cells            6.5
    mCHsinu                1.275
...
LAYER_TYPE_NAME = 'channel:CB_LABYRINTH'
RAW_SCALARS = {'ntg': 0.372, 'width_cells': 10.18, 'depth_cells': 6.5, 'mCHsinu': 1.275, 'mFFCHprop': 0.325, 'probAvulInside': 0.06}
